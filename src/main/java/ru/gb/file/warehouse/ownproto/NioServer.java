package ru.gb.file.warehouse.ownproto;
...
public class NioServer {
    ...
    static {
        try (InputStream fileInputStream = NioServer.class.getResourceAsStream("/client.properties")) {
    ...
    private static FileChannel getFileChannel(SocketChannel socketChannel) throws FileNotFoundException {
        ...
        if (fileChannel == null) {
            ...
            String serverDir = rootPath + "/server-dir/";
            RandomAccessFile fileForSend = new RandomAccessFile(serverDir + fileName, "rw");
